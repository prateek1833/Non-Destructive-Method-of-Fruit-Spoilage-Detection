...
Serial.println("Point the Triad away and press a key to begin with 
illumination...");
...
sensor.takeMeasurementsWithBulb(); // This is a hard wait while all 18 
...
lcd.clear();
lcd.setCursor(0, 0);
lcd.print(String(sensor.getCalibratedA()) + " " + 
String(sensor.getCalibratedB()) + " " + String(sensor.getCalibratedC()));
lcd.setCursor(0, 1);
lcd.print(String(sensor.getCalibratedD()) + " " + 
String(sensor.getCalibratedE()) + " " + String(sensor.getCalibratedF()));
break;
case 2:
...
lcd.clear();
lcd.setCursor(0, 0);
lcd.print(String(sensor.getCalibratedG()) + " " + 
String(sensor.getCalibratedH()) + " " + String(sensor.getCalibratedR()));
lcd.setCursor(0, 1);
lcd.print(String(sensor.getCalibratedI()) + " " + 
String(sensor.getCalibratedS()) + " " + String(sensor.getCalibratedJ()));
break;
case 3:
...
lcd.clear();
lcd.setCursor(0, 0);
lcd.print(String(sensor.getCalibratedT()) + " " + 
String(sensor.getCalibratedU()) + " " + String(sensor.getCalibratedV()));
lcd.setCursor(0, 1);
lcd.print(String(sensor.getCalibratedW()) + " " + 
String(sensor.getCalibratedK()) + " " + String(sensor.getCalibratedL()));
break;
case 4:
Serial.print("\tMQ3: ");
Serial.print(mq3PPM);
